...
export default function RoomReservation() {
  ...
  const getRoomSchedulesForDay = (roomId: string, date: Date) => {
    const schedules = getSchedulesForEquipment(roomId, 'room');
                      ...
                      <td key={i} className="px-3 py-4 whitespace-nowrap text-sm text-gray-500 relative group border border-gray-100">
                        ...
                        <div className="min-h-[80px]">
                          {schedules.map(schedule => (
                            <div 
                              key={schedule.id} 
                              className="mb-1 px-2 py-1 rounded text-xs truncate bg-emerald-100 text-emerald-800 border-l-4 border-emerald-500"
                            >
